...
public final class Functors {
	...
	public final static Filter<Integer> evenFilter = new Filter<Integer>(isEvenFunctor);

	public final static Filter<Integer> pEvenFilter = new ParallelFilter<Integer>(isEvenFunctor);
	...
	public final static Fold<Integer,Integer> sumFold = new Fold<Integer,Integer>(sumFoldFunctor);

	public final static Fold<Integer,Integer> pSumFold = new ParallelFold<Integer>(sumFoldFunctor);
	...
	public final static Map<Integer,Boolean> isPrimeMap = new Map<Integer,Boolean>(isPrimeFunctor);

	public final static Map<Integer,Boolean> pIsPrimeMap = new ParallelMap<Integer,Boolean>(isPrimeFunctor);

	public final static Filter<Integer> primesFilter = new Filter<Integer>(isPrimeFunctor);

	public final static Filter<Integer> pPrimesFilter = new ParallelFilter<Integer>(isPrimeFunctor);
	...
	public final static Functor<List<Integer>,List<Integer>> qSort = new Functor<List<Integer>,List<Integer>>() {
		...
		public List<Integer> apply(final List<Integer> as) {
			...
			final Filter<Integer> biggerFilter = new Filter<Integer>(new FilterFunctor<Integer>() {
				@Override
			...
			final Filter<Integer> smallerEqFilter = new Filter<Integer>(new FilterFunctor<Integer>() {
				@Override
				public Boolean apply(final Integer i) {
					return i <= pivot;
				}
